...
export const themePresets = {
  ...
  vxai: createTheme('light', {
    label: 'VXAI (Default)',
    tokens: {
      '--vx-primary': '#4f46e5',
      '--vx-primary-strong': '#4338ca',
      '--vx-primary-soft': 'rgba(79, 70, 229, 0.1)',
      '--vx-secondary': '#64748b',
      '--vx-success': '#10b981',
      '--vx-warning': '#f59e0b',
      '--vx-danger': '#ef4444',
      ...
      '--vx-bg-accent': '#f1f5f9',
      '--vx-surface': '#ffffff',
      '--vx-surface-strong': '#f8fafc',
      '--vx-surface-hover': '#f1f5f9',
      '--vx-border': '#e2e8f0',
      '--vx-border-strong': '#cbd5e1',
      '--vx-text': '#0f172a',
      '--vx-text-secondary': '#334155',
      '--vx-text-muted': '#64748b',
      '--vx-shadow-sm': '0 1px 2px -1px rgba(0, 0, 0, 0.1), 0 1px 3px 0 rgba(0, 0, 0, 0.1)',
      '--vx-shadow': '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)',
      '--vx-shadow-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1)',
      '--vx-glass-bg': 'rgba(255, 255, 255, 0.8)',
      '--vx-glass-bg-strong': 'rgba(255, 255, 255, 0.95)',
      '--vx-glass-border': '#e2e8f0',
      '--vx-glass-shadow': 'none',
      '--vx-glass-highlight': 'none',
      '--vx-radius-sm': '4px',
      '--vx-radius': '6px',
      '--vx-radius-lg': '8px',
      '--vx-radius-xl': '12px',
  ...
  'vxai-dark': createTheme('dark', {
    label: 'VXAI Dark',
    tokens: {
      '--vx-primary': '#6366f1',
      '--vx-primary-strong': '#4f46e5',
      '--vx-primary-soft': 'rgba(99, 102, 241, 0.16)',
      '--vx-secondary': '#cbd5e1',
      '--vx-success': '#34d399',
      '--vx-warning': '#fbbf24',
      '--vx-danger': '#f87171',
      ...
      '--vx-bg-accent': '#0f172a',
      '--vx-surface': '#0f172a',
      '--vx-surface-strong': '#020617',
      '--vx-surface-hover': '#1e293b',
      '--vx-border': 'oklch(27.8% 0.033 256.848)',
      '--vx-border-strong': '#334155',
      '--vx-text': 'oklch(96.8% 0.007 247.896)',
      '--vx-text-secondary': '#94a3b8',
      '--vx-text-muted': '#64748b',
      '--vx-shadow-sm': '0 1px 2px -1px rgba(0, 0, 0, 0.4), 0 1px 3px 0 rgba(0, 0, 0, 0.4)',
      '--vx-shadow': '0 4px 6px -1px rgba(0, 0, 0, 0.4), 0 2px 4px -2px rgba(0, 0, 0, 0.4)',
      '--vx-shadow-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.4), 0 4px 6px -4px rgba(0, 0, 0, 0.4)',
      '--vx-glass-bg': 'rgba(15, 23, 42, 0.7)',
      '--vx-glass-bg-strong': 'rgba(15, 23, 42, 0.95)',
      '--vx-glass-border': 'oklch(27.8% 0.033 256.848)',
      '--vx-glass-shadow': 'none',
      '--vx-glass-highlight': 'none',
      '--vx-radius-sm': '4px',
      '--vx-radius': '6px',
